...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is PlayingCard&&(identical(other.rank, rank) || other.rank == rank)&&(identical(other.suit, suit) || other.suit == suit));
}
...
/// Create a copy of PlayingCard
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? rank = null,Object? suit = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( Rank rank,  Suit suit)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PlayingCard() when $default != null:
return $default(_that.rank,_that.suit);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( Rank rank,  Suit suit)  $default,) {final _that = this;
switch (_that) {
case _PlayingCard():
return $default(_that.rank,_that.suit);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( Rank rank,  Suit suit)?  $default,) {final _that = this;
switch (_that) {
case _PlayingCard() when $default != null:
return $default(_that.rank,_that.suit);case _:
  return null;
...
class _PlayingCard extends PlayingCard {
  const _PlayingCard({required this.rank, required this.suit}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _PlayingCard&&(identical(other.rank, rank) || other.rank == rank)&&(identical(other.suit, suit) || other.suit == suit));
}
...
/// Create a copy of PlayingCard
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? rank = null,Object? suit = null,}) {
